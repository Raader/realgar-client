...
const Modal = ({ children, active, header, close }) => {
  ...
  return (
    ...
    >
      <div
        className="w-full lg:1/2 lg:max-w-lg h-screen lg:h-auto bg-gray-100 mx-auto lg:rounded-xl lg:bg-white lg:p-4 overflow-auto animate__animated animate__slideInDown animate__fast pb-20 lg:pb-4"
        ref={ref}
      >
